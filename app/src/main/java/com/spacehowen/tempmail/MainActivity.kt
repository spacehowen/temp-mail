package com.spacehowen.tempmail
...
import com.spacehowen.tempmail.adapter.EmailrecyclerViewAdapter
import com.spacehowen.tempmail.data.EmailDataModel
...
class MainActivity : AppCompatActivity() {
    ...
    //val TEMP_MAIL_API_KEY : String = "b2b3609eafmsh8455b953c90ca95p1890bbjsnecb2020f96a9"

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_main)

        val editText = findViewById<EditText>(R.id.api_key)
        ...
        btnGetDomains.setOnClickListener{
            ...
            Toast.makeText( this,"Obteniendo nombres de dominio. Espere por favor....", Toast.LENGTH_LONG).show()
            ...
            object : StringRequest(
                ...
                override fun getHeaders(): Map<String, String> {
                    ...
                    params["x-rapidapi-key"] = editText.text.toString()
                    // NOT VARIABLE
        ...
        btnCreateMail.setOnClickListener {
            ...
            Log.d(ContentValues.TAG, "onCreate: md5 hash: "+hashEmail)
                ...
                Response.Listener { response -> // response
                    ...
                    try {
                        for (i : Int in response.indices) {
                            ...
                            Log.d(ContentValues.TAG, "onCreate: JSONArray : " + jsonArray)

                            Log.d(ContentValues.TAG, "onCreate: Mail Text :" + mail_text)
                        ...
                        try {
                            ...
                            addEmailData(
                                msg,
                                "inténtalo de nuevo después de unos segundos !",
                                " "
                            )
                            emailsAdapter.notifyDataSetChanged()
        ...
        btnCopy.setOnClickListener{
            ...
            Toast.makeText(this, "Correo electrónico copiado correctamente al portapapeles !", Toast.LENGTH_SHORT)
                .show()
        }
